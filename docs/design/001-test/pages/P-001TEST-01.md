...
| 面包屑 | Breadcrumb | 首页 / P2-修复-编排推进 / P2-修复-编排推进列表页 |
| 左侧 | Sidebar | 二级导航菜单 |
...
| C-003 | DataTable | Container | 主内容 | 核心内容组件 |
| C-004 | Pagination | Navigation | 主内容 | 分页器 |
...
| B-003 | 新建 | ActionBar | navigate.to(/p2/create) | - | 有创建权限 | E1002
| B-004 | 搜索 | SearchBar | data.search | GET /api/v1/p2?q= | - | -
| B-005 | 导出 | ActionBar | data.export | GET /api/v1/p2/export | 有权限 | E1003

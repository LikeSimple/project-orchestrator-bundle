...
```mermaid
---
title: P2-修复-编排推进 Page Flow
---
flowchart TD
    START(["用户访问"]) -->|入口| P-001TEST-01["P2-修复-编排推进列表页"]
    P-001TEST-01[/"P2-修复-编排推进列表页<br/><small>/p2/list</small>"\]
    P-001TEST-02["P2-修复-编排推进详情页<br/><small>/p2/detail/:id</small>"]
    START --> |用户访问| P-001TEST-01
    P-001TEST-01 --> |点击列表项| P-001TEST-02
    P-001TEST-02 --> |返回| P-001TEST-01
    ...
    class P-001TEST-01 list
    class P-001TEST-02 detail
    class START entry
